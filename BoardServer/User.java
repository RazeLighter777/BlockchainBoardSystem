...
/**
 * All of these users are kept in a distributed hash table. This data is
 * permanently kept in a blockchain.
 */
public class User {
     ...
     *
     * @param name Must be NAME_SIZE in length. Refers to the username of the
     * user. This name means nothing.
